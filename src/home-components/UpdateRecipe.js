				...
				<Modal.Body>
					<Form>
						...
						<Form.Group controlId='inspiredBy' onChange={handleInput}>
							...
							<Form.Control type='text' placeholder='Enter inspiredBy Update' />
						</Form.Group>

						<Form.Group controlId='allergies' onChange={handleInput}>
							<Form.Label>Allergies</Form.Label>
							<Form.Control type='text' placeholder='Enter allergies Update' />
						</Form.Group>
						...
						<Form.Group controlId='directions' onChange={handleInput}>
							...
							<Form.Control type='text' placeholder='Enter directions Update' />
						</Form.Group>
					</Form>
				</Modal.Body>
				<Modal.Footer>
